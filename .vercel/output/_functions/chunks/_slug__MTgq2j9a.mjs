...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const category = findSubcategory("bestemmingen", slug);
  if (!category) return Astro2.redirect("/bestemmingen");
